...
👋 Добро пожаловать \n \U0001F1FA\U0001F1FF Выберите язык бота \U0001F1F7\U0001F1FA""",
    ...
    "dilers": ["👤 Dilerlar", "👤 Дилеры"],

    "action for electric": ["🔌 Elektriklar uchun aksiya", "🔌 Акция для электриков"],

    "action for businessman": ["💼 Tadbirkorlar uchun aksiya", "💼 Акция для бизнесменов"],
    ...
    "type promocode": [
        "Do'kon tomonidan taqdim qilingan promokodni kiriting", 
